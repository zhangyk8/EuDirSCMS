...
@ray.remote
def MS_DirKDE_Fs(y_0, data, h=None, eps=1e-7, max_iter=1000, diff_method='all'):
    '''
...
@ray.remote
def MS_KDE_Fs(mesh_0, data, h=None, eps=1e-7, max_iter=1000):
    '''
...
@ray.remote
def SCMS_Log_DirKDE_Fs(mesh_0, data, d=1, h=None, eps=1e-7, max_iter=1000, 
                    stop_cri='proj_grad'):
    '''
...
@ray.remote
def SCMS_Log_KDE_Fs(mesh_0, data, d=1, h=None, eps=1e-7, max_iter=1000, 
                 stop_cri='proj_grad'):
    '''
