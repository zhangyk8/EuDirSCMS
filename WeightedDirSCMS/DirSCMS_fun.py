...
Description: This script implements the functions of (weighted) directional KDE and 
...
def SCMS_Log_DirKDE_org(mesh_0, data, d=1, h=None, eps=1e-7, max_iter=1000, wt=None):
    '''
    Subspace Constrained Mean Shift algorithm using the original directional 
    mean shift vector in its iterative steps with the log density and 
