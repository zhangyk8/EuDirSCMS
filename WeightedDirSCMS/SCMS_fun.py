...
Description: This script contains code for (weighted) Euclidean KDE and 
subspace constrained mean shift (SCMS) algorithm with Gaussian kernel.
"""
...
def KDE(x, data, h=None, wt=None):
    '''
    (Weighted) d-dim Euclidean KDE with Gaussian kernel
...
def MS_KDE(mesh_0, data, h=None, eps=1e-7, max_iter=1000, wt=None):
    '''
    (Weighted) Mean Shift Algorithm with Gaussian kernel
...
def SCMS_KDE(mesh_0, data, d=1, h=None, eps=1e-7, max_iter=1000, wt=None, 
             stop_cri='proj_grad'):
    '''
    (Weighted) Subspace Constrained Mean Shift Algorithm with Gaussian kernel
...
def SCMS_Log_KDE(mesh_0, data, d=1, h=None, eps=1e-7, max_iter=1000, wt=None,
                 stop_cri='proj_grad'):
    '''
    (Weighted) Subspace Constrained Mean Shift algorithm with log density 
    and Gaussian kernel
